...
/* harmony default export */ __webpack_exports__["default"] = (JSON.parse('[["Office","Staff in 2019","# of responses ","% of responses (relative response rate)"],["Mexico",55,98,"178.18"],["MENA",10,13,"130.00"],["Andino",90,92,"102.22"],["India",21,18,"85.71"],["CZ Rep.",23,19,"82.61"],["Africa",89,58,"65.17"],["Spain",117,67,"57.26"],["International",323,179,"55.42"],["New Zealand",80,44,"55.00"],["France + Luxembourg",91,46,"50.55"],["Australia Pacific",55,26,"47.27"],["European Unit",16,7,"43.75"],["Nordic",149,64,"42.95"],["Belgium",155,59,"38.06"],["United Kindgom",175,65,"37.14"],["MED",36,13,"36.11"],["Canada",70,25,"35.71"],["Italy",92,30,"32.61"],["Switzerland",91,29,"31.87"],["Greece",54,17,"31.48"],["CEE",200,61,"30.50"],["Netherlands",103,30,"29.13"],["Russia",112,31,"27.68"],["SEA",200,51,"25.50"],["Germany",389,75,"19.28"],["Brazil",251,35,"13.94"],["East Asia",324,43,"13.27"],["USA",353,41,"11.61"],["Japan",33,3,"9.09"],["Other",null,null,0],["Prefer not to say",null,null,0]]'));

/***/ }),

/***/ "./assets/src/js/blocks/Chart/ChartEditor.js":
/*!***************************************************!*\
  !*** ./assets/src/js/blocks/Chart/ChartEditor.js ***!
  \***************************************************/
/***/ (function() {
...
/***/ "./assets/src/js/blocks/Chart/ChartEditorScript.js":
/*!*********************************************************!*\
  !*** ./assets/src/js/blocks/Chart/ChartEditorScript.js ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ChartEditor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ChartEditor */ "./assets/src/js/blocks/Chart/ChartEditor.js");
/* harmony import */ var _ChartEditor__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_ChartEditor__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _ChartFrontend__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ChartFrontend */ "./assets/src/js/blocks/Chart/ChartFrontend.js");
...
registerBlockType(BLOCK_NAME, {
  ...
  keywords: ['chart', 'table', 'graph'],
  supports: {
    html: true // Enables "Edit as HTMl" block option.
  },
  attributes,
  edit: () => /*#__PURE__*/React.createElement("p", null, "Chart Block Editor would render from ChartEditor"),
  save: () => /*#__PURE__*/React.createElement("p", null, "Saves the updated blocks attributes and should return the ChartFrontend")
});
...
/***/ "./assets/src/js/blocks/Chart/ChartFrontend.js":
/*!*****************************************************!*\
  !*** ./assets/src/js/blocks/Chart/ChartFrontend.js ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   ChartFrontend: function() { return /* binding */ ChartFrontend; }
/* harmony export */ });
// Build the frontend here
const ChartFrontend = _ref => {
  let {
    title,
    description,
    url,
  ...
  return /*#__PURE__*/React.createElement("canvas", {
    className: `block chart-block ${className ?? ''}`
  }, title && /*#__PURE__*/React.createElement("header", null, /*#__PURE__*/React.createElement("h2", {
...
/***/ "./assets/src/js/blocks/Chart/ChartScript.js":
/*!***************************************************!*\
  !*** ./assets/src/js/blocks/Chart/ChartScript.js ***!
  \***************************************************/
/***/ (function() {
...
function rgbToHex(rgbString) {
  const [r, g, b] = rgbString.substring(rgbString.indexOf('(') + 1, rgbString.lastIndexOf(')')).split(',').map(color => parseInt(color.trim(), 10));
...
/***/ "./assets/src/js/frontend/charts.js":
/*!******************************************!*\
  !*** ./assets/src/js/frontend/charts.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _data_survey_data_xlsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../data/survey_data.xlsx */ "./assets/data/survey_data.xlsx");
...
let labels = [];
for (let i = 1; i <= 10; i++) {
  labels[i] = _data_survey_data_xlsx__WEBPACK_IMPORTED_MODULE_1__["default"][i][0];
}
let data = [];
for (let i = 1; i <= 10; i++) {
  data[i] = _data_survey_data_xlsx__WEBPACK_IMPORTED_MODULE_1__["default"][i][3];
}
...
if (!canvas) {
  ...
  new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Chart(canvas, {
    type: 'bar',
    data: {
      labels: labels,
      datasets: [{
        label: _data_survey_data_xlsx__WEBPACK_IMPORTED_MODULE_1__["default"][0][3],
        data: data,
        borderWidth: 1
      }]
    },
...
/* harmony import */ var _frontend_charts_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./frontend/charts.js */ "./assets/src/js/frontend/charts.js");
/* harmony import */ var _frontend_externaltools__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./frontend/externaltools */ "./assets/src/js/frontend/externaltools.js");
/* harmony import */ var _frontend_externaltools__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_frontend_externaltools__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _frontend_gfquiz_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./frontend/gfquiz.js */ "./assets/src/js/frontend/gfquiz.js");
/* harmony import */ var _frontend_gfquiz_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_frontend_gfquiz_js__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _blocks_Chart_ChartScript_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./blocks/Chart/ChartScript.js */ "./assets/src/js/blocks/Chart/ChartScript.js");
/* harmony import */ var _blocks_Chart_ChartScript_js__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_blocks_Chart_ChartScript_js__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _blocks_Chart_ChartEditor_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./blocks/Chart/ChartEditor.js */ "./assets/src/js/blocks/Chart/ChartEditor.js");
/* harmony import */ var _blocks_Chart_ChartEditor_js__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_blocks_Chart_ChartEditor_js__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _blocks_Chart_ChartEditorScript_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./blocks/Chart/ChartEditorScript.js */ "./assets/src/js/blocks/Chart/ChartEditorScript.js");
/* harmony import */ var _blocks_Chart_ChartFrontend_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./blocks/Chart/ChartFrontend.js */ "./assets/src/js/blocks/Chart/ChartFrontend.js");
/* provided dependency */ var jQuery = __webpack_require__(/*! jquery */ "jquery");
